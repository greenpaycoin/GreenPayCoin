...
pkgdatadir = $(datadir)/GreenPayCoin
pkgincludedir = $(includedir)/GreenPayCoin
pkglibdir = $(libdir)/GreenPayCoin
pkglibexecdir = $(libexecdir)/GreenPayCoin
...
CONFIG_HEADER = $(top_builddir)/src/config/GreenPayCoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/GreenPayCoin-config.h.in \
...
ACLOCAL = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = GreenPayCoin-cli
BITCOIN_DAEMON_NAME = GreenPayCoind
BITCOIN_GUI_NAME = GreenPayCoin-qt
BITCOIN_TX_NAME = GreenPayCoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = otool
OTOOL64 = :
PACKAGE = GreenPayCoin
PACKAGE_BUGREPORT = www.GreenPayCoin.org
PACKAGE_NAME = GreenPayCoin Core
PACKAGE_STRING = GreenPayCoin Core 1.0.0
PACKAGE_TARNAME = GreenPayCoin
PACKAGE_URL = 
...
abs_builddir = /Users/vishalsachdeva/Desktop/GPC
abs_srcdir = /Users/vishalsachdeva/Desktop/GPC
abs_top_builddir = /Users/vishalsachdeva/Desktop/GPC
abs_top_srcdir = /Users/vishalsachdeva/Desktop/GPC
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/vishalsachdeva/Desktop/GPC/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_GreenPayCoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_GreenPayCoin_coverage.info test_GreenPayCoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/GreenPayCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/GreenPayCoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/GreenPayCoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/GreenPayCoin-config.h
$(top_srcdir)/src/config/GreenPayCoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/GreenPayCoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/GreenPayCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GreenPayCoin-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GreenPayCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_GreenPayCoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_GreenPayCoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_GreenPayCoin_filtered.info: test_GreenPayCoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_GreenPayCoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_GreenPayCoin_coverage.info: baseline_filtered_combined.info test_GreenPayCoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_GreenPayCoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_GreenPayCoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_GreenPayCoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_GreenPayCoin.coverage/.dirstamp:  test_GreenPayCoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_GreenPayCoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_GreenPayCoin.coverage/ total.coverage/ $(OSX_APP)
