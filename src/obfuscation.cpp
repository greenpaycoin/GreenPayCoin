...
/* *** BEGIN OBFUSCATION MAGIC - GreenPayCoin **********
    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                adds up to a cost of 0.001 GreenPayCoin per transaction on average.
            */
            if (r <= 10) {
...
void CObfuscationPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100GreenPayCoin+1 ( bit on if present )
    // bit 1 - 10GreenPayCoin+1
    // bit 2 - 1GreenPayCoin+1
    // bit 3 - .1GreenPayCoin+1
    // bit 3 - non-denom
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("GreenPayCoin-obfuscation");
