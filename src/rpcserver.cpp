...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"GreenPayCoin", "masternode", &masternode, true, true, false},
        {"GreenPayCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"GreenPayCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"GreenPayCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"GreenPayCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"GreenPayCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"GreenPayCoin", "startmasternode", &startmasternode, true, true, false},
        {"GreenPayCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"GreenPayCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"GreenPayCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"GreenPayCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"GreenPayCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"GreenPayCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"GreenPayCoin", "mnbudget", &mnbudget, true, true, false},
        {"GreenPayCoin", "preparebudget", &preparebudget, true, true, false},
        {"GreenPayCoin", "submitbudget", &submitbudget, true, true, false},
        {"GreenPayCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"GreenPayCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"GreenPayCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"GreenPayCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"GreenPayCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"GreenPayCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"GreenPayCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"GreenPayCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"GreenPayCoin", "mnsync", &mnsync, true, true, false},
        {"GreenPayCoin", "spork", &spork, true, true, false},
        {"GreenPayCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"GreenPayCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use GreenPayCoind, or the -server option to GreenPayCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> GreenPayCoin-cli " + methodname + " " + args + "\n";
}
