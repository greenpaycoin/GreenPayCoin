...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 GreenPayCoin at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zgpc send
enum ZerocoinSpendStatus {
    ZGreenPayCoin_SPEND_OKAY = 0,                            // No error
    ZGreenPayCoin_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZGreenPayCoin_WALLET_LOCKED = 2,                         // Wallet was locked
    ZGreenPayCoin_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZGreenPayCoin_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZGreenPayCoin_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZGreenPayCoin_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZGreenPayCoin_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZGreenPayCoin_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZGreenPayCoin_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZGreenPayCoin_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZGreenPayCoin_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZGreenPayCoin_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZGreenPayCoin_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZGreenPayCoin_SPENT_USED_ZGreenPayCoin = 14                       // Coin has already been spend
};
...
public:
    ...
    void ZGreenPayCoinBackupWallet();
    ...
    */
    ...
    void setZGreenPayCoinAutoBackups(bool fEnabled)
    {
