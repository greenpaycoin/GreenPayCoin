...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GreenPayCoin Core GreenPayCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  GreenPayCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GreenPayCoin transaction") + "\n" +
                               "  GreenPayCoin-tx [options] -create [commands]   " + _("Create hex-encoded GreenPayCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GreenPayCoin transaction
