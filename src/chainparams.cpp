...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("046b5d90358436ade560162fa358bef10b4c4ca98803ac70b26a2b3c2e9d0ff7ab21f79fe8e3399f99995b0a8827fee058f3c5bc1d4d74a60c3eba97d968361e66");
        nDefaultPort = 29721;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 GreenPayCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // GreenPayCoin: 0.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // GreenPayCoin: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // GreenPayCoin: 60 Seconds
        nMaturity = 19;
         ...
         */
        const char* pszTimestamp = "GreenPayCoin new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0466def2f5beec6d867fc24f67548f092bccbb401dca91b7c22407ba8474fe7f9f013534e42fa0cd6f1fbc3f9c66d236d76606af4fe5531d8ecebad4ca894b06bf") << OP_CHECKSIG;
...
public:
    CTestNetParams()
    {
       ...
       hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet GreenPayCoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet GreenPayCoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet GreenPayCoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet GreenPayCoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet GreenPayCoin BIP44 coin type is '1' (All coin's testnet default)
