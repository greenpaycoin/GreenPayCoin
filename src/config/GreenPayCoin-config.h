/* src/config/GreenPayCoin-config.h.  Generated from GreenPayCoin-config.h.in by configure.  */
/* src/config/GreenPayCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GreenPayCoin_CONFIG_H

#define GreenPayCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.GreenPayCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GreenPayCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GreenPayCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "GreenPayCoin"
