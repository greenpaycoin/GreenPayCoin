                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received GreenPayCoin from zgpc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zgpc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zsnd));
