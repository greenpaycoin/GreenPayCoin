                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GreenPayCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GreenPayCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GreenPayCoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zgpc"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GreenPayCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GreenPayCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GreenPayCoin"));
    ...
    openAction->setStatusTip(tr("Open a GreenPayCoin: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GreenPayCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("GreenPayCoin Core"); // default title
...
/** Creates context menu, its actions, and GreenPayCoins up all the relevant signals for mouse events. */
