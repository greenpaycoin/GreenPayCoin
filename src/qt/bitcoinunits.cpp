...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case GreenPayCoin:
            return QString("GreenPayCoin");
        case msnd:
            return QString("Milli-GreenPayCoin (1 / 1" THIN_SP_UTF8 "000)");
        case usnd:
            return QString("Micro-GreenPayCoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
