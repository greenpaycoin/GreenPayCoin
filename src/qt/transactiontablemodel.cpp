...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted GreenPayCoin to zgpc");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zgpc");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received GreenPayCoin from zgpc");
    case TransactionRecord::ZerocoinSpend_Change_zsnd:
        return tr("Minted Change as zgpc from zgpc Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zgpc to GreenPayCoin");
