...
- [Building GreenPayCoin](#building-GreenPayCoin)
...
Clone the git repositories for GreenPayCoin and gitian and then checkout the GreenPayCoin version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the GreenPayCoin repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the GreenPayCoin repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/GreenPayCoin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/eastcoastcrypto/GreenPayCoin
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/GreenPayCoin.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit GreenPayCoin=${COMMIT} --url GreenPayCoin=${URL} ../GreenPayCoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit GreenPayCoin=${COMMIT} --url GreenPayCoin=${URL} ../GreenPayCoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit GreenPayCoin=${COMMIT} --url GreenPayCoin=${URL} ../GreenPayCoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/GreenPayCoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/GreenPayCoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/GreenPayCoin-build.assert
```
