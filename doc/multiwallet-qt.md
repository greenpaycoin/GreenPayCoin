...
In order to support loading of multiple wallets in GreenPayCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is GreenPayCoin.cpp.
...
Changes to GreenPayCoin.cpp
----------------------
GreenPayCoin.cpp is the entry point into GreenPayCoin-qt, and as such, will require some minor modifications to provide hooks for
